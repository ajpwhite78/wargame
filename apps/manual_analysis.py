...
#                    padding: 10px;
        ...
        with col5:
             ...
             if statement_out_download_type == "PNG":
                ...
                st.text("")
                st.text("")
                statements_out = ([df_income_statement_out_png, "manual_analysis_income_statement", "png", "Income Statement", 36], [df_cash_flow_statement_out_png, "manual_analysis_cash_flow_statement", "png", "Cash Flow Statement", 36], [df_balance_sheet_out_png, "manual_analysis_balance_sheet", "png", "Balance Sheet", 36])
                downloader = MultiFileDownloader()
