...
'''
    ...
    dict(font=dict(color="#25476A", size=25, family="sans-serif"), x=0.5, y=0, xanchor='center',
        ...
        with col1:
            st.plotly_chart(manual_current_rating_fig, config={'displayModeBar': False}, use_container_width=True, height=340)
        ...
        subtext1A = '<p class="subtext" style="margin-top: -10em; margin-bottom: 0em;"><span style="font-family:sans-serif; color:#25476A; font-size: 2em;">Financial Statements</span></p>'
