...
'''
        ...
        with col1:
            instructions_text = '<p class="instructions_text" style="margin-top: 2em; margin-bottom: 0em; text-align: justify;"><span style="font-family:sans-serif; color:#25476A; font-size: 1em;">Click "ReRun" once you have made your selection or click "Reset" to reset to the default values.</span></p>'
