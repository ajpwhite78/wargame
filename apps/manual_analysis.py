...
def app():
    ...
    line3 = '<hr class="line3" style="height:0.1875em; border:0em; background-color: #25476A; margin-top: -0.4em; margin-bottom: -12em;">'
...
'''
  ...
  #      st.markdown("<style>.full-width-chart .chart-container { display: flex; justify-content: center; }</style>", unsafe_allow_html=True)
        ...
        with col1:
            left_text = "<span style='margin-bottom: -5em; font-family: sans-serif; color: #25476A; font-size: 1.7em;'>Income Statement</span>"
            right_text = "<span style='margin-bottom: -5em; font-family: sans-serif; color: #25476A; font-size: 0.8em;'>(blue fields indicate change)</span></span>"
