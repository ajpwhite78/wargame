...
#                    padding: 10px;
        ...
        left_text = "<span style='font-family: sans-serif; color: #FAFAFA; font-size: 2em;'>Manual Analysis</span>"
        right_text = "<span style='font-family: sans-serif; color: #FAFAFA; font-size: 2em;'>{}&nbsp;&nbsp;&nbsp;{}</span>".format(st.session_state.user_entity_name, st.session_state.user_reporting_period)
