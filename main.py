...
with col5:
    ...
    with inner_cols[0]:       
        st.markdown(
            """<style>div.stButton > button:first-child {background-color:#25476A; color: #FAFAFA; border-color: #FAFAFA; font-size: 1em; border-width: 0.1875em; border-radius: 0.1875em; width:4em; height:2em} div.stButton > button:hover {background-color: rgba(111, 114, 222, 0.6); color: #25476A; border-color: #25476A}</style>""",
            unsafe_allow_html=True)
        st.text("")
