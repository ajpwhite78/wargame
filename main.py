...
with col5:
    ...
    <div class="button-div2">
        <button type="submit" class="button2" name="submit1" value="submit1_button">Run</button>
        <button type="submit" class="button2" name="cancel1" value="cancel1_button">Cancel</button>
    </div>
    """        
